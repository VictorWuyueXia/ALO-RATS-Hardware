...
from preview_robot import HOME, ROOT
from preview_tissue import TARGETS_MM
from run_robot_preview import PreviewInteraction
...
"""
    result = subprocess.run(
        [sys.executable, "-c", code], cwd=Path(__file__).parent,
...
def test_keyboard_workflow_and_clean_exit(monkeypatch, return_key):
    ...
    import run_robot_preview as launcher
