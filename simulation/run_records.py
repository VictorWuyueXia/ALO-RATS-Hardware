"""Append-only execution evidence and explicitly separated truth/observation archives."""
...
def json_value(value):
    """Preserve unbounded diagnostic distances as explicit strings in valid JSON."""
...
class RunRecords:
    """Record each irreversible virtual pulse before any subsequent acquisition can fail."""

    def __init__(self, output):
        self.output = Path(output)
        for name in ("motions", "scans", "observed", "truth"):
