...
from alo_rats_hardware.beam import (
    AXIS_TOLERANCE_RAD, INTERCEPT_TOLERANCE_MM, STANDOFF_M, BeamCalibration, beam_errors,
)
from simulation.robot.collision_scene import CollisionScene, link_pose
from simulation.robot.robot_scene import HOME, load_robot
...
class RobotExecutor:
    ...
    def __init__(self, client, bounds_mm, verifier, poll):
        ...
        self.calibration = BeamCalibration(world_base, np.linalg.inv(world_base) @ world_planning, STANDOFF_M)
