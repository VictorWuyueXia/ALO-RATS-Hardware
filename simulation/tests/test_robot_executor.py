...
from alo_rats_hardware.beam import STANDOFF_M, BeamCalibration, beam_errors
from simulation.robot.collision_scene import link_pose
from simulation.robot.robot_executor import OperatorAbort, RobotExecutor, require_coverage
from simulation.robot.robot_scene import HOME, ROOT
...
def test_beam_transform_round_trip(tilts, xy):
    ...
    calibration = BeamCalibration(world_base, base_planning, STANDOFF_M)
